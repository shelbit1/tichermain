...
export function Pricing() {
  return (
    <section id="pricing" className="border-t border-zinc-200/70 bg-white py-24">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-12 rounded-2xl border-2 border-blue-500/70 bg-white p-8 shadow-sm sm:p-10">
          ...
          <p className="mt-4 text-center text-xs text-zinc-500">
            1 день пробного периода — без списания. 3 эссе бесплатно без карты.
          </p>
        </div>
      </div>
    </section>
